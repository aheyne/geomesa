...
**Current release: 2.0.2.ncUser1**

  &nbsp;&nbsp;&nbsp;&nbsp;
  [**HBase**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.0.2.ncUser1/geomesa-hbase_2.11-2.0.2.ncUser1-bin.tar.gz) |
  [**Accumulo**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.0.2.ncUser1/geomesa-accumulo_2.11-2.0.2.ncUser1-bin.tar.gz) |
  [**Cassandra**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.0.2.ncUser1/geomesa-cassandra_2.11-2.0.2.ncUser1-bin.tar.gz) |
  [**Kafka**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.0.2.ncUser1/geomesa-kafka_2.11-2.0.2.ncUser1-bin.tar.gz) |
  [**FileSystem**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.0.2.ncUser1/geomesa-fs_2.11-2.0.2.ncUser1-bin.tar.gz) |
  [**Source**](https://github.com/locationtech/geomesa/archive/geomesa_2.11-2.0.2.ncUser1.tar.gz) |
  [**CheckSums**](https://github.com/locationtech/geomesa/releases/geomesa_2.11-2.0.2.ncUser1)
...
```bash
$ gpg2 --verify geomesa-accumulo_2.11-2.0.2.ncUser1-bin.tar.gz.asc geomesa-accumulo_2.11-2.0.2.ncUser1-bin.tar.gz
```
...
libraryDependencies ++= Seq(
  "org.locationtech.geomesa" %% "geomesa-utils" % "2.0.2.ncUser1",
  ...
)
```
