...
//      //val QUERY_EXACT_COUNT    = GeoMesaProperties.GEOMESA_FORCE_COUNT
//      //val QUERY_COST_TYPE      = GeoMesaProperties.GEOMESA_QUERY_COST_TYPE
//      //val QUERY_TIMEOUT_MILLIS = GeoMesaProperties.GEOMESA_QUERY_TIMEOUT_MILLIS
//      //val SCAN_RANGES_TARGET   = GeoMesaProperties.GEOMESA_SCAN_RANGES_TARGET
//      //val SCAN_BATCH_RANGES    = GeoMesaProperties.GEOMESA_SCAN_RANGES_BATCH
//    }
//
//    object BatchWriterProperties {
//      //val WRITER_LATENCY_MILLIS  = GeoMesaProperties.GEOMESA_BATCHWRITER_LATENCY_MILLS
//      //val WRITER_MEMORY_BYTES    = GeoMesaProperties.GEOMESA_BATCHWRITER_MEMORY
//      //val WRITER_THREADS         = GeoMesaProperties.GEOMESA_BATCHWRITER_MAXTHREADS
//      //val WRITE_TIMEOUT_MILLIS   = GeoMesaProperties.GEOMESA_BATCHWRITER_TIMEOUT_MILLS
//    }
//
//    object FeatureIdProperties {
//      //val FEATURE_ID_GENERATOR = GeoMesaProperties.GEOMESA_FEATURE_ID_GENERATOR
//    }
//
//    object StatsProperties {
//      //val STAT_COMPACTION_MILLIS = GeoMesaProperties.GEOMESA_STATS_COMPACT_MILLIS
//    }
//
//    case class propOrDefault(prop: String) {
//      def get: String = GeoMesaProperties.getProperty(prop)
//
//      def option: Option[String] = {
//        val res = GeoMesaProperties.getProperty(prop)
//        Option(if (res.nonEmpty) res else null)
//      }
//
